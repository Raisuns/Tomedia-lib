  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{ Request::is('profile') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('profile.edit') }}"><i class="fas fa-user-cog"></i>
          <span>Profil</span></a>
      </li>
      @else
      <div class="sidebar-brand">
        <a href="{{ route('anggota.dashboard.index') }}">Tomedia Lib</a>
      </div>
      <div class="sidebar-brand sidebar-brand-sm">
        <a href="{{ route('anggota.dashboard.index') }}">TL</a>
      </div>
      <ul class="sidebar-menu">
        <li class="{{ Request::segment(2) === 'dashboard' ? 'active' : '' }}">
        ...
        <li class="{{ Request::segment(2) === 'books' ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('anggota.books.index') }}"><i class="fas fa-book"></i>
