...
<div class="row">
      ...
      <form action="" method="POST" class="book_borrower_form">
        ...
        <table class="table">
          ...
          <tr>
            <td>Dari Tanggal</td>
            <td>:</td>
            <td class="text-wrap">{{ $book_user->date_start }}</td>
          </tr>
          <tr>
            <td>Sampai Tanggal</td>
            <td>:</td>
            <td class="text-wrap">{{ $book_user->date_end }}</td>
          </tr>
          <tr>
            <td>Keterangan</td>
            <td>:</td>
  ...
  <div class="col-lg-5">
    ...
    <div class="py-4">
      <a href="{{ route('anggota.book-borrowers-history.index') }}" class="btn btn-primary">Kembali</a>
    </div>
    </form>
  </div>
</div>
    ...
    $("#book-swal-show-button").click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#history_book_image_detail_show").attr("src", url + image);
    ...
    $("#user-swal-show-button").click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#history_user_image_detail_show").attr("src", url + image);
